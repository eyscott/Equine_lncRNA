...
lncRNA_exp <-lncRNA_exp[ ,c("V2","V3","V4","transcriptName","calcTPM","V1","length")]
...
all_exp <- merge(overallExpression_coord, all,by.x=c("V1","V2","V3"),by.y=c("V2","V3","V4"))  
names(all_exp)[1]<-paste("chr")
...
mean_TPM_I<-mean(novel_I_exp_l[["calcTPM"]])#4.9
mean_TPM_II<-mean(novel_II_exp_l[["calcTPM"]])#1.6
mean_TPM_III<-mean(novel_III_exp_l[["calcTPM"]])#0.7
mean_TPM_intergenic<-mean(intergenic_exp_l[["calcTPM"]])#0.48
mean_length_I<-mean(novel_I_exp_l[["length"]])#1861
mean_length_II<-mean(novel_II_exp_l[["length"]])#1415
mean_length_III<-mean(novel_III_exp_l[["length"]])#1198
mean_length_intergenic<-mean(intergenic_exp_l[["length"]])#910
total_length_I <-sum(novel_I_exp_l[["length"]])#2182978
total_length_II <-sum(novel_II_exp_l[["length"]])#2692672
total_length_III <-sum(novel_III_exp_l[["length"]])#3601715
total_length_intergenic <-sum(intergenic_exp_l[["length"]])#13615750
