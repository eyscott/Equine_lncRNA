...
bedtools intersect -c -a novel_I_f3.bed -b refined_nolncRNA_5.bed -sorted -s -f > novel_I_5.bed
bedtools intersect -c -a novel_II_f3.bed -b refined_nolncRNA_5.bed -sorted -s -f > novel_II_5.bed
bedtools intersect -c -a novel_III_f3.bed -b refined_nolncRNA_5.bed -sorted -s -f > novel_III_5.bed
bedtools intersect -c -a intergenic_f3.bed -b refined_nolncRNA_5.bed -sorted -s -f 0.25 > intergenic_5.bed
bedtools intersect -c -a known_ncRNA_f3.bed -b refined_nolncRNA_5.bed -sorted -s -f 0.25 > known_5.bed
