...
bedtools getfasta -s -fi equCab2.0_genome.fa -bed P.bed -name -fo P.fa
...
makeblastdb -in Homo_sapiens.GRCh38.ncrna.fa -input_type fasta -dbtype nucl -parse_seqids -out hg38_ncrna_db
